...
namespace C2
{
    internal static class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            File.WriteAllText("C:\\PJATK\\4th\\PSM\\ItemThrowing\\ItemThrowing\\Data\\export.csv", "Time, Sx, Sy, Vx, Vy, Ax, Ay\n");
            do // Euler ------------------------------------------------------------------------------------------------
            {
            ...
            File.AppendAllText("C:\\PJATK\\4th\\PSM\\ItemThrowing\\ItemThrowing\\Data\\export.csv",
            ...
            File.AppendAllText("C:\\PJATK\\4th\\PSM\\ItemThrowing\\ItemThrowing\\Data\\export.csv", t + "," + Math.Round(s[0]*100)/100 + ",0,0,0,0,0");
        }
